...
RailsAdmin.config do |config|
  ...
  #     configure :talks, :has_many_association

  #   # Found columns:

  #     configure :id, :integer
  #     configure :name, :string
  #     configure :enroll_url, :string
  #     configure :proposals_url, :string
  #     configure :happens_at, :datetime
  #     configure :created_at, :datetime
  #     configure :updated_at, :datetime
  ...
  #     configure :video_code, :integer
  #     configure :audio_code, :integer
  #     configure :created_at, :datetime
  #     configure :updated_at, :datetime
